...
var ResourceView = View.extend({
  ...
  headIntroHtml: function() {
    return '' +
      '<th class="fc-resource-name ' + this.widgetHeaderClass + '" ' + this.resourceNameStyleAttr() + '>' +
        '<span>' + // needed for matchCellWidths
          htmlEscape(this.opt('resourceColTitle')) +
        '</span>' +
      '</th>';
  },
  ...
  resourceIntroHtml: function(resourceIndex) {
    return '<td class="fc-resource-name ' + this.widgetContentClass + '" ' +
      this.resourceNameStyleAttr() + '>' + this.resources[resourceIndex].name + '</td>';
  },
  ...
  introHtml: function() {
    return '<td class="fc-resource-name" ' + this.resourceNameStyleAttr() + '></td>';
  },
  ...
  resourceNameStyleAttr: function() {
    if (this.resourceColWidth !== null) {
      return 'style="width:' + this.resourceColWidth + 'px"';
    }
    return '';
  },
